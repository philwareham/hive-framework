...
!https://travis-ci.org/philwareham/hive-framework.png?branch=master!:https://travis-ci.org/philwareham/hive-framework !https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!:http://gruntjs.com/ !https://david-dm.org/philwareham/hive-framework/dev-status.svg(devDependency Status)!:https://david-dm.org/h5bp/html5-boilerplate#info=devDependencies
