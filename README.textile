...
!https://travis-ci.org/philwareham/hive-framework.svg?branch=master!:https://travis-ci.org/philwareham/hive-framework !https://david-dm.org/philwareham/hive-framework/status.svg(Dependency Status)!:https://david-dm.org/philwareham/hive-framework#info=dependencies !https://david-dm.org/philwareham/hive-framework/dev-status.svg(devDependency Status)!:https://david-dm.org/philwareham/hive-framework#info=devDependencies
