...
!https://travis-ci.org/philwareham/hive-framework.png?branch=master!:https://travis-ci.org/philwareham/hive-framework !<http://https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!
